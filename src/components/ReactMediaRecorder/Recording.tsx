...
function LiveStreamPreview({ stream }) {
  ...
  return <video ref={videoPreviewRef} width={340} height={450} autoPlay />;
}
...
function Player({ srcBlob }) {
  ...
  return <video src={URL.createObjectURL(srcBlob)} width={340} height={450} controls> <track default /> </video>;
}
